...
\usepackage{wrapfig}			% integration of graphics with wrapping text
...
\usepackage{float}
\usepackage[section]{placeins}	% Pictures and Tables are inside one section
...
\SetKwFor{BeginRDP}{RDP (}{) $\lbrace$}{$\rbrace$}
